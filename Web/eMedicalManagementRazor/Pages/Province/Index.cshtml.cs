...
namespace eMedicalManagementRazor.Pages.Province
{
	public class IndexModel : PageModel
    {
        ...
        public IndexModel(ILogger<IndexModel> logger, IProvinceRepositoryAsync province, IUnitOfWork unitOfWork, IRazorRenderService renderService)
        {
            _logger = logger;
            _province = province;
